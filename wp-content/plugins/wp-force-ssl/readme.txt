...
WP Force SSL helps you redirect insecure HTTP traffic to secure HTTPS one **without the need to touch any code**. Just activate Force SSL and everything will be configured for you. The entire site will move to HTTPS using your SSL certificate. It works with any SSL certificate. It can be free SSL certificate from Let's Encrypt or a paid SSL certificate.
