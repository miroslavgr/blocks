(function ($) {
    ...
    var adapters = {
        jquery_ui: function (context) {
            ...
            if (context.$select_field.find(':selected').length && context.$select_field.find(':selected').text()) {
                context.$text_field.attr('placeholder', context.$select_field.find(':selected').text());
            }
